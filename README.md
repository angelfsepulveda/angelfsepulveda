<!--
  **1430382/1430382** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
  ...
  <br/>
  <br/>
  I'm Angel Sepulveda, IT Engineer focused on building AI-powered backends and agentic systems on AWS.
  <br/>
  <br/>
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/Amazon_ECS_Fargate-232F3E?style=for-the-badge&logo=amazon-aws&logoColor=white">
  </p>
  ...
  <table>
    <tr>
      <td>Text-to-SQL AI agent for pharmaceutical analytics. Multi-database querying via natural language using LangGraph + Amazon Bedrock + Streamlit.</td>
    </tr>
    <tr>
      <td>Serverless conversational analytics assistant on AWS. LangGraph agent with human-in-the-loop reasoning, deployed on ECS Fargate, querying Athena through Glue Catalog. IaC with
  Terraform.</td>
    </tr>
    <tr>
      <td>FastAPI backend for natural language-to-SQL query processing and call history management. Integrates Amazon Bedrock and Amazon QuickSight for business intelligence delivery.</td>
    </tr>
    <tr>
      <td>Central hub for AI agent development on SAP's enterprise platform. Vector search over SAP HANA Cloud, semantic embeddings via SAP AI Core, and Joule (SAP Digital Assistant)
